            ...
            <form>
                ...
                <div class="items-center mx-auto mb-3 space-y-4 max-w-screen-sm sm:flex sm:space-y-0">
                    <div class="relative w-full">
                        ...
                        <input class="block p-3 pl-10 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 sm:rounded-none sm:rounded-l-lg focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="What are you looking for" type="search" id="search" name="search"
                        autocomplete="off">
                    </div>
                    <div>
    ...
    <section class="bg-white dark:bg-gray-900 rounded-lg">
        <div class="py-4 px-4 mx-auto max-w-screen-xl lg:py-8 lg:px-6">
            <div class="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
                ...
                <article class="p-6 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
                    <div class="flex justify-between items-center mb-5 text-gray-500">
                        <span class="bg-{{ $post->category->color }}-100 text-primary-800 text-xs font-medium inline-flex items-center px-2.5 py-0.5 rounded dark:bg-primary-200 dark:text-primary-800">
                            <a href="/posts?category={{ $post->category->slug }}" class="hover:underline" rel="category">{{ $post->category->name }}</a>
                        </span>
                    ...
                    <div class="flex justify-between items-center">
                        <div class="flex items-center space-x-3">
                            ...
                            <span class="font-medium text-xs dark:text-white">
                                <a href="/posts?author={{ $post->author->username }}" class="hover:underline text-slate-500 text-base mb-2" rel="author">
                                    {{ $post->author->name }}
                                </a>
                            </span>
                        </div>
                ...
                @empty
                    <div>
                        <p class="font-semibold text-xl my-4 mx-auto">Aritcle not Found!</p>
